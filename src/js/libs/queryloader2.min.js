...
! function e(t, n, i) {
	...
	2: [function(e, t, n) {
		...
		function i(e, t) {
			...
			var o;
			return e.nodeName ? "img" !== e.nodeName.toLowerCase() ? t(new Error("Element supplied is not an image")) : e.src && e.complete && void 0 !== e.naturalWidth ? t(null, !0) : (n(e, "load", !0, i), n(e, "error", !0, i), void((e.readyState || e.complete) && (o = e.src, e.src = r, e.src = o))) : t(new Error("First argument must be an image element"))
		}
			...
			r = {
				getImageSrcs: function(e) {
					if (this.sources = [], "undefined" != typeof e && (this.findImageInElement(e), this.deepSearch === !0))
						for (var t = e.querySelectorAll("*"), n = 0; n < t.length; n++) "SCRIPT" !== t[n].tagName && this.findImageInElement(t[n]);
				...
				determineUrlAndType: function(e) {
					...
					return "undefined" != typeof i.backgroundImage && "" !== i.backgroundImage && "none" !== i.backgroundImage || "undefined" != typeof e.style.backgroundImage && "" !== e.style.backgroundImage && "none" !== e.style.backgroundImage ? (t = i.backgroundImage || e.style.backgroundImage, n = "background") : "img" === e.nodeName.toLowerCase() && (t = e.src), {
						url: t,
						type: n
					}
				},
				...
				stripUrl: function(e) {
					return e = e.replace(/url\(\'/g, ""), e = e.replace(/url\(/g, ""), e = e.replace(/\'\)/g, ""), e = e.replace(/\)/g, ""), e = e.replace(/"/g, "")
				},
				validUrl: function(e) {
	...
	7: [function(e, t, n) {
		...
		var i = e("./LoadingBar"),
			...
			o = {
				...
				create: function() {
					...
					var svgLogo = '<svg viewBox="0 0 126.5 204" class="logo-mark"><path d="M126.5,112.3v50.9H63.9l-5.5,3.7l-17.5,33.4l-3.7,3.7H0h0v-37.1l37.5-71.5l-3.1-3.7H0V40.8h62.6l5.5-3.7\
            L85.6,3.7L89.3,0h37.2h0v37.1L89,108.5l3.1,3.7H126.5z" /></svg>';
					this.element.innerHTML += svgLogo;
				},
				applyStyling: function() {
		...
		t.exports = function(e) {
			...
			return t.parentElement = e, t.idName = "qLoverlay", t.percentageId = "qlPercentage", t.className = "queryloader__overlay", t.element = null, t.loadingBar = null, t.percentage = null, t.barColor = "#ff0000", t.backgroundColor = "#FFF", t.barHeight = 1, t.fadeOutTime = 300, t.showPercentage = !1, t
		}
	}, {
		"./LoadingBar": 4,
		"./Percentage": 5
		...
		Function.prototype.bind || (Function.prototype.bind = function(e) {
			...
			return function(n) {
				...
				if (e.prototype = null, arguments.length > 1) {
					...
					for (var o in r) t.call(r, o) && (i[o] = r[o])
				}
				return i
			}
		}())
		...
		t.exports = function() {
			var e = window.setInterval(function() {
				if ("undefined" != typeof document.getElementsByTagName("body")[0]) {
					...
					t.style.position = "fixed", t.style.width = "100%", t.style.height = "100%", t.style.zIndex = "9999", t.style.backgroundColor = "#FFF", t.style.left = "0", t.style.top = "0", t.setAttribute("id", "qLtempOverlay"), document.getElementsByTagName("body")[0].appendChild(t), window.clearInterval(e)
				}
			}, 1)
		}
	}, {}],
		...
		var i = e("./../ImagePreloader"),
			...
			o = {
				...
				createOverlay: function() {
					this.overlay = r(this.element), this.overlay.idName = this.options.overlayId, this.overlay.percentageId = this.options.percentageId, this.overlay.backgroundColor = this.options.backgroundColor, this.overlay.barHeight = this.options.barHeight, this.overlay.barColor = this.options.barColor, this.overlay.showPercentage = this.options.percentage, this.overlay.fadeOutTime = this.options.fadeOutTime, "undefined" != typeof this.element && this.overlay.init()
				},
